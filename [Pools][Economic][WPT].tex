...
\begin{itemize}
	...
	\item Nachdem der \textit{WPS} erst an der \textit{WUNDER} gekoppelt wurde, muss dies hinsichtlich des \nameref{fees-model} und der \nameref{fees-charging} de facto wieder rückgängig gemacht werden, damit die Fees zur Nutzung des \textit{Pools-Services} nicht von etwaigen Kursschwankungen des \textit{WUNDER} beeinflusst werden.
...
Die Rechnerei der anschließenden Kapitel (insbesondere XXX und YYY) wird stets die Excel-Datei \href{pool-economics-V3.xlsx}{Pools-Economics} begleitet!

\vspace{0.5cm}


\vspace{0.3cm}
\todo{TODO: Erstmals auf \textit{Economics-Excel} verweisen.}

%\href{run:/127.0.0.1/temp/test.txt}{Textdatei}
%\href{run:pool-economics-V3.xlsx}{Pools-Economics}

\href{pool-economics-V3.xlsx}{Pools-Economics}

\href{hallo.txt}{Hallo}

\href{run:C:/Users/Slava/White-Paper/nft.pdf}{This is my link}
