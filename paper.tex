...
\input{[01][Abstract]/[Abstract]}    % binde die Datei 'Abstract.tex' ein
\input{[02][Einleitung]/[Einleitung]}    % binde die Datei 'Einleitung.tex' ein
\input{[03][Vision]/[Vision]}    % binde die Datei 'Vision.tex' ein
\input{[04][Unser Ansatz]/[Unser Ansatz]}    % binde die Datei 'Unser Ansatz.tex' ein
\input{[05][Economics]/[Economics]}    % binde die Datei 'Economics.tex' ein
\input{[06][NFT-Pass]/[NFT-Pass]}    % binde die Datei 'NFT-Pass.tex' ein
\input{[07][SSI]/[SSI]}    % binde die Datei 'SSI.tex' ein
\input{[08][Project Guard]/[Project Guard]}    % binde die Datei 'Project Guard.tex' ein
\input{[09][Pools]/[Pools]}    % binde die Datei 'Pools.tex' ein
\input{[10][Community]/[Community]}    % binde die Datei 'Community.tex' ein
\input{[11][Zusammenfassung]/[Zusammenfassung]}    % binde die Datei 'Zusammenfassung.tex' ein
\input{[12][Anhang]/[Anhang]}    % binde die Datei 'Anhang.tex' ein
