...
\input{[06][SSI]/[SSI]}    % binde die Datei 'SSI.tex' ein
\input{[07][Zusammenfassung]/[Zusammenfassung]}    % binde die Datei 'Zusammenfassung.tex' ein
\newpage
...
\input{[A][NFT-Pass]/[NFT-Pass]}    % binde die Datei 'NFT-Pass.tex' ein
\newpage

\input{[B][Pools]/[Pools]}    % binde die Datei 'Pools.tex' ein
\newpage

\input{[C][Project Guard]/[Project Guard]}    % binde die Datei 'Project Guard.tex' ein
\newpage


\input{[D][Anhang]/[Anhang]}    % binde die Datei 'Anhang.tex' ein
\newpage
