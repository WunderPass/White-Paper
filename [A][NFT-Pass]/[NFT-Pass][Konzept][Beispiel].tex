...
\begin{figure}[h!]
  \centering
  \subfloat[][]{\includegraphics[width=0.4\linewidth]{{"[A][NFT-Pass]/images/pass 1"}}}%
  \qquad
  \subfloat[][]{\includegraphics[width=0.4\linewidth]{{"[A][NFT-Pass]/images/pass 2"}}}%
...
\begin{figure}[h!]
  \centering
  \subfloat[][]{\includegraphics[width=0.4\linewidth]{{"[A][NFT-Pass]/images/pass 3"}}}%
  \qquad
  \subfloat[][]{\includegraphics[width=0.4\linewidth]{{"[A][NFT-Pass]/images/pass 4"}}}%
