...
Allen relevanten Erklärungen vorweggreifend folgt unser fundamentale \textit{Token-Economics}-Ansatz für die Pools-Project-Token:

\vspace{0.2cm}

\begin{Praemisse}[Dividende auf den Pools-Project-Token]
\vspace{0.2cm}
...
\todo{Gewinnbeteiligung der Token-Holder an den kassierten Fees $\rightarrow$ Kurs-Entwicklung bei Projekt-Erfolg}
...
Diesem Ansatz folgend schlagen wir grob folgende beim Token-Design zu berücksichtigenden Mechanismen vor:

\vspace{0.2cm}

\begin{Algo}[Mechanism-Design-Aspekte des Pools-Project-Tokens]
\vspace{0.2cm}
