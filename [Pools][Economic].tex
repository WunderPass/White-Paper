...
An der Abarbeitung dieser Liste werden wir uns durch das Kapitel hangeln und fangen bei der Einflussnahme auf die Token-Zirkulation an:
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\end{itemize}
	\end{itemize}
	\item \todo{Gebühren-Zahler:} künstlichen Token-Bedarf über längeren Zeitraum mittels \textit{Pending-Fees} forcieren
\end{itemize}
