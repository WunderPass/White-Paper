...
Diese NFT-Property soll zwar einem ähnlichen abstufenden Raritätsprinzip zu Grunde liegen wie die Main-Property. Dabei wird sie jedoch nicht mehr einem first-come-first-serve-, sondern stattdessen einem Zufallsprinzip folgen.

Ebenfalls abweichend von der Beschaffenheit der Main-Property soll bei dieser Pro\-perty die Rarität nicht mittels einer absoluten Obergrenze abgebildet werden, sondern mittels einer relativen. (Dies zahlt auf die oben formulierte Anforderung an ein \textbf{gemeinnützig gewinnbringenden Value} unseres \textit{NFT-Pass} ein.
...
\textbf{Achtung:} Wir befüllen die Trommel ausschließlich nachdem sie komplett leer geworden ist und nicht etwa in der Zwischenzeit.
