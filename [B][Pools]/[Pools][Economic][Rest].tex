...
\begin{itemize}
	\item Argumente des Design-Mechanismus \ref{doller-vs-wunder} evtl. in eigenes Kapitel auslagern.
	\item Die Einlagen für den \textit{WPT} sind idealerweise in WUNDER zu erbringen. Dazu benötigen wir einen durch Fiat gedeckten Liquidity-Bootstrapping-Pool für den \textit{WUNDER}. Das muss ggf. seperat beschrieben werden.
\end{itemize}

\vspace{0.5cm}

\todo{WunderPass selbst ist der erste Investor in WPT. Die von uns erworbenen WPT können kreativ zu Marketing- und Akquisitionszwecken (\textbf{Rewards}) verwendet werden. Vielleicht ist zu dem Thema ein eigenes Kapitel von Nöten.}
