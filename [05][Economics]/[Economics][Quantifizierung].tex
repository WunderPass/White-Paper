...
\input{[05][Economics]/[Economics][Quantifizierung][Definitionen]}    % binde die Datei '[Economics][Quantifizierung][Definitionen].tex' ein
...
\input{[05][Economics]/[Economics][Quantifizierung][WP][Status quo]} % binde die Datei '[Economics][Quantifizierung][WP][Status quo].tex' ein

\input{[05][Economics]/[Economics][Quantifizierung][WP][Messbarkeit]} % binde die Datei '[Economics][Quantifizierung][WP][Messbarkeit].tex' ein

\input{[05][Economics]/[Economics][Quantifizierung][WP][Fazit]} % binde die Datei '[Economics][Quantifizierung][WP][Fazit].tex' ein
...
\input{[05][Economics]/[Economics][Quantifizierung][deprecated]}    % binde die Datei '[Economics][Quantifizierung][deprecated].tex' ein
